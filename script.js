...
const translations = {
  es: {
    ...
    service2Title: 'Gestión impositiva y contable mensual', service2Text: 'IVA, IIBB, retenciones, presentaciones ante AFIP, AGIP y ARBA, e información fiscal preparada a tiempo.',
  ...
  en: {
    ...
    service2Title: 'Monthly tax and accounting management', service2Text: 'VAT, turnover tax, withholdings, filings with AFIP, AGIP, and ARBA, plus timely preparation of tax information.',
